...
pub struct AppState {
    ...
    pub width: u32,
    pub height: u32,
    pub surface: Option<wl_surface::WlSurface>, // ✅ Made pub
...
// ✅ Explicit dispatchers (Macro removed to fix syntax errors)
impl Dispatch<wl_compositor::WlCompositor, ()> for AppState {
    fn event(_: &mut Self, _: &wl_compositor::WlCompositor, _: <wl_compositor::WlCompositor as Proxy>::Event, _: &(), _: &Connection, _: &QueueHandle<Self>) {}
}
impl Dispatch<wl_shm::WlShm, ()> for AppState {
    fn event(_: &mut Self, _: &wl_shm::WlShm, _: <wl_shm::WlShm as Proxy>::Event, _: &(), _: &Connection, _: &QueueHandle<Self>) {}
}
impl Dispatch<wl_shm_pool::WlShmPool, ()> for AppState {
    fn event(_: &mut Self, _: &wl_shm_pool::WlShmPool, _: <wl_shm_pool::WlShmPool as Proxy>::Event, _: &(), _: &Connection, _: &QueueHandle<Self>) {}
}
impl Dispatch<wl_surface::WlSurface, ()> for AppState {
    fn event(_: &mut Self, _: &wl_surface::WlSurface, _: <wl_surface::WlSurface as Proxy>::Event, _: &(), _: &Connection, _: &QueueHandle<Self>) {}
}
impl Dispatch<wl_buffer::WlBuffer, ()> for AppState {
    fn event(_: &mut Self, _: &wl_buffer::WlBuffer, _: <wl_buffer::WlBuffer as Proxy>::Event, _: &(), _: &Connection, _: &QueueHandle<Self>) {}
}
impl Dispatch<ZwlrLayerShellV1, ()> for AppState {
    fn event(_: &mut Self, _: &ZwlrLayerShellV1, _: <ZwlrLayerShellV1 as Proxy>::Event, _: &(), _: &Connection, _: &QueueHandle<Self>) {}
}
...
pub struct WallpaperEngine {
    ...
    video_shm_buffer: Option<(memmap2::MmapMut, wl_buffer::WlBuffer)>, // ✅ Now inside struct!
...
impl WallpaperEngine {
    ...
    // ✅ Made pub so main.rs can call it
        ...
        match cmd {
            IpcCommand::SetWallpaper { path, animation, duration } => {
                ...
                if let Some(pid) = self.video_pid.take() {
                    eprintln!("🛑 Killing old video process (PID: {})", pid);
                ...
                *self.video_buffer.lock().unwrap() = None;
                ...
                if Self::is_video(&path) {
                    ...
                    match self.display_with_animation(&path, anim, duration) {
                        Ok(_) => { crate::config::save(&path, &animation, duration); format!("✅ Image wallpaper changed: {}", path) }
